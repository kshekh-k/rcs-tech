...
export default function ContactSection() {
  ...
  return (
    <section className="relative py-28 bg-slate-100/50 border-t border-slate-200 before:absolute before:-translate-x-1/2 before:translate-y-1/2 before:bottom-0 before:left-0 before:w-96 before:h-96 before:rounded-full before:border before:border-blue-100">
      {/* Background Effects */}
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-3 mt-5">
              <div className="bg-white rounded p-3 shadow-md flex gap-2 items-center">
